...
router.get("/", protectedRoute_1.default, donation_controllers_1.getAllFood);
router.get("/user", protectedRoute_1.default, donation_controllers_1.getFoodByCurrentUser);
router.get("/:id", protectedRoute_1.default, donation_controllers_1.getFoodById);
router.patch("/update/:id", protectedRoute_1.default, donation_controllers_1.updateFood);
router.delete("/delete/:id", protectedRoute_1.default, donation_controllers_1.deleteFood);
